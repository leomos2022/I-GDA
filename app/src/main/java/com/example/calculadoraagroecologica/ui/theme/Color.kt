...
val md_theme_light_onPrimaryContainer = Color(0xFF213600)
val md_theme_light_background = Color(0xFFF8FBEF)
val md_theme_light_surface = Color(0xFFF8FBEF)
val md_theme_light_onBackground = Color(0xFF213600)
val md_theme_light_onSurface = Color(0xFF213600)
...
val SoftLeafGreen = Color(0xFFAED581) // Verde hoja suave
...
val PastelBlue = Color(0xFFD0F4FF)
val PastelLight = Color(0xFFF8FBEF)
val PastelSurface = Color(0xFFE6F4EA)
val ButtonGreen = Color(0xFF5A8F6A)
